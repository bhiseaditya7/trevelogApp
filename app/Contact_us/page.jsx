  ...
  <div className="container">
    <div className="row justify-content-md-center">
      <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
        <h2 className="mb-4 display-5 text-center dark">Contact Us</h2>
        <p className="text-secondary mb-5 text-center">Lorem ipsum dolor sit amet consectetur adipisicing..</p>
